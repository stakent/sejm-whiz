...
def sanitize_query(query: str) -> str:
    ...
    query = re.sub(r'[\x00-\x08\x0e-\x1f\x7f-\x9f]', '', query)  # Remove control chars but keep tab/newline
...
def parse_date_string(date_str: str) -> Optional[str]:
    ...
    polish_months = {
        ...
        'lutego': '02', 'lutego': '02',
        'marca': '03', 'marca': '03',
        'kwietnia': '04', 'kwietnia': '04',
        'maja': '05', 'maja': '05',
        'czerwca': '06', 'czerwca': '06',
        'lipca': '07', 'lipca': '07',
        'sierpnia': '08', 'sierpnia': '08',
        'września': '09', 'września': '09',
        'października': '10', 'października': '10',
        'listopada': '11', 'listopada': '11',
        'grudnia': '12', 'grudnia': '12'
    }
    ...
    if match:
        ...
        if month:
            ...
            if month in ['02'] and day_num > 29:  # February
                return None
            elif month in ['04', '06', '09', '11'] and day_num > 30:  # April, June, Sept, Nov
                return None
