...
class LegalSemanticAnalyzer:
    ...
    def _init_semantic_fields(self):
        ...
        self.semantic_fields = {
            'civil_law': SemanticField(
                ...
                terms=[
                    'własność', 'posiadanie', 'użytkowanie', 'spadek', 'dziedziczenie',
                    'umowa', 'zobowiązanie', 'szkoda', 'odszkodowanie', 'odpowiedzialność',
                    'małżeństwo', 'rozwód', 'alimenty', 'kuratela', 'opieka'
                ],
                weight=1.0,
                context_terms=['kodeks cywilny', 'prawo cywilne', 'stosunki cywilnoprawne']
            ),
            'criminal_law': SemanticField(
                field_name='criminal_law',
                terms=[
                    'przestępstwo', 'wykroczenie', 'kara', 'grzywna', 'więzienie',
                    'napaść', 'kradzież', 'oszustwo', 'zabójstwo', 'przemoc',
                    'prokurator', 'oskarżyciel', 'podejrzany', 'świadek'
                ],
                weight=1.0,
            ...
            'administrative_law': SemanticField(
                ...
                terms=[
                    'organ administracji', 'decyzja administracyjna', 'postępowanie administracyjne',
                    'odwołanie', 'skarga', 'samorząd', 'gmina', 'powiat', 'województwo',
                    'pozwolenie', 'koncesja', 'licencja', 'rejestracja', 'kontrola'
                ],
                weight=1.0,
                context_terms=['kodeks postępowania administracyjnego', 'prawo administracyjne']
            ),
            'constitutional_law': SemanticField(
                field_name='constitutional_law',
                terms=[
                    'konstytucja', 'prawa podstawowe', 'wolności obywatelskie',
                    'sejm', 'senat', 'prezydent', 'rada ministrów', 'trybunał konstytucyjny',
                    'demokracja', 'suwerenność', 'rozdział władz'
                ],
                weight=1.0,
            ...
            'tax_law': SemanticField(
                field_name='tax_law',
                terms=[
                    'podatek', 'składka', 'opłata', 'danina', 'VAT', 'CIT', 'PIT',
                    'ordynacja podatkowa', 'zobowiązanie podatkowe', 'ulga podatkowa',
                    'kontrola podatkowa', 'interpretacja podatkowa'
                ],
                weight=1.0,
            ...
            'labor_law': SemanticField(
                ...
                terms=[
                    'umowa o pracę', 'stosunek pracy', 'pracodawca', 'pracownik',
                    'wynagrodzenie', 'urlop', 'zwolnienie', 'wypowiedzenie',
                    'kodeks pracy', 'czas pracy', 'bezpieczeństwo pracy', 'związki zawodowe'
                ],
                weight=1.0,
    ...
    def analyze_argumentative_structure(self, text: str) -> Dict[str, Any]:
        ...
        return {
            'arguments': arguments,
            'argument_counts': {arg_type: len(args) for arg_type, args in arguments.items()},
