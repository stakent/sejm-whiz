...
class ComprehensiveLegalAnalyzer:
    ...
    def analyze_document(self, text: str) -> dict:
        ...
        # Semantic analysis
        semantic_results = self.semantic_analyzer.perform_comprehensive_semantic_analysis(text)
        
        # Relationship analysis
        relationship_results = self.relationship_extractor.perform_comprehensive_relationship_analysis(text)
    ...
    def extract_key_insights(self, text: str) -> dict:
        ...
        if 'legal_nlp_analysis' in analysis:
            ...
            if 'legal_concepts' in nlp_data:
                ...
                insights['main_legal_concepts'] = [
                    ...
                    for c in sorted(concepts, key=lambda x: x['confidence'], reverse=True)[:5]
                ]
        ...
        if 'relationship_analysis' in analysis:
            ...
            if 'relationships' in rel_data:
                ...
                insights['key_relationships'] = [
                    ...
                    for r in sorted(relationships, key=lambda x: x['confidence'], reverse=True)[:5]
                ]
        ...
        if 'semantic_analysis' in analysis:
            ...
            if 'semantic_fields' in sem_data:
                insights['semantic_fields'] = list(sem_data['semantic_fields'].items())[:5]
