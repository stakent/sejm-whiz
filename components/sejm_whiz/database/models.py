...
class LegalDocument(Base):
    ...
    cross_references_from = relationship("CrossReference", foreign_keys="CrossReference.source_document_id", back_populates="source_document")
    cross_references_to = relationship("CrossReference", foreign_keys="CrossReference.target_document_id", back_populates="target_document")
...
class CrossReference(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid4)
    source_document_id = Column(UUID(as_uuid=True), ForeignKey("legal_documents.id"), nullable=False)
    target_document_id = Column(UUID(as_uuid=True), ForeignKey("legal_documents.id"), nullable=False)
