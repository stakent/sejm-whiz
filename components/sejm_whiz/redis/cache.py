...
class RedisCache:
    ...
    def cache_document(self, document_id: str, document_data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
    ...
    def cache_document_embedding(self, document_id: str, embedding: List[float], ttl: Optional[int] = None) -> bool:
    ...
    def cache_search_results(self, query_hash: str, results: List[Dict[str, Any]], ttl: Optional[int] = None) -> bool:
    ...
    def cache_eli_response(self, eli_id: str, response_data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
    ...
    def cache_user_session(self, session_id: str, session_data: Dict[str, Any], ttl: Optional[int] = None) -> bool:
