...
from sejm_whiz.document_ingestion import DocumentIngestionPipeline, TextProcessor as DocumentTextProcessor
...
from sejm_whiz.database import DocumentOperations, get_database_manager
from sejm_whiz.redis.connection import RedisConnection
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if document_ids:
            ...
            documents = await self.client.search_documents(
                filters={"type": category} if category else None,
                limit=10
            )
        
        return {
            **data,
            "eli_documents": documents,
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "sejm_proceedings" in data:
            ...
            for proceeding in proceedings:
                processed_text = self.processor.clean_text(proceeding.get("content", ""))
        ...
        return {
            **data,
            **processed_data,
            "step_completed": "text_processing"
        }
...
class EmbeddingGenerationStep(PipelineStep):
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            **data,
            **embeddings_data,
            "step_completed": "embedding_generation"
        }
...
class DatabaseStorageStep(PipelineStep):
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            **data,
            **storage_results,
            "step_completed": "database_storage"
        }
...
async def main():
    ...
    try:
        ...
        logger.info(f"Pipeline completed successfully. Result keys: {list(result.keys())}")
        ...
        batch_data = [
            ...
            {"session_id": "12", "date_range": {"start": "2024-03-01", "end": "2024-03-31"}},
        ]
