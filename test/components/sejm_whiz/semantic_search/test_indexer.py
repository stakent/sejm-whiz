...
class TestDocumentIndexer:
    ...
    def test_index_document_success(self, indexer, sample_document, mock_embedder, mock_vector_operations):
        """Test successful document indexing."""
        with patch('sejm_whiz.semantic_search.indexer.process_legal_document') as mock_process:
    ...
    def test_index_document_overwrite_existing(self, indexer, sample_document, mock_embedder):
    ...
    def test_index_document_embedding_failure(self, indexer, sample_document, mock_embedder):
        ...
        assert result.error == "Failed to generate embedding: Embedding generation failed"
        assert result.embedding_dimensions == 0
    
    def test_batch_index_documents(self, indexer, mock_embedder, mock_vector_operations):
    ...
    def test_batch_index_with_existing_embeddings(self, indexer, mock_embedder, mock_vector_operations):
    ...
    def test_reindex_all_documents(self, indexer, mock_embedder, mock_vector_operations):
    ...
    def test_get_indexing_statistics_failure(self, indexer, mock_vector_operations):
        ...
        mock_vector_operations.get_embedding_statistics.side_effect = Exception("Database error")
    ...
    def test_batch_index_partial_failure(self, indexer, mock_embedder, mock_vector_operations):
        ...
        mock_vector_operations.update_document_embedding.side_effect = mock_update_embedding
