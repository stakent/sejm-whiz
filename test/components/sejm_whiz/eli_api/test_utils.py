...
class TestSanitizeQuery:
    ...
    def test_normal_queries(self):
        ...
        for input_query, expected in test_cases:
            ...
            assert result == expected, f"Input: {input_query!r}, Expected: {expected!r}, Got: {result!r}"
    ...
    def test_dangerous_patterns(self):
        ...
        for query in dangerous_queries:
            ...
            assert query.lower() not in result.lower(), f"Dangerous pattern not removed: {query}"
...
class TestNormalizeDocumentType:
    ...
    def test_valid_normalizations(self):
        ...
        for input_type, expected in test_cases:
            ...
            assert result == expected, f"Input: {input_type}, Expected: {expected}, Got: {result}"
...
class TestParseDateString:
    ...
    def test_valid_dates(self):
        ...
        for input_date, expected in test_cases:
            ...
            assert result == expected, f"Input: {input_date}, Expected: {expected}, Got: {result}"
...
class TestFormatEliId:
    ...
    def test_normal_formatting(self):
        ...
        for input_id, expected in test_cases:
            ...
            assert result == expected, f"Input: {input_id}, Expected: {expected}, Got: {result}"
...
class TestIsAmendmentDocument:
    ...
    def test_amendment_indicators(self):
        ...
        for text in amendment_texts:
            assert is_amendment_document(text) is True, f"Should detect amendment: {text}"
    ...
    def test_non_amendment_documents(self):
        ...
        for text in non_amendment_texts:
            assert is_amendment_document(text) is False, f"Should not detect amendment: {text}"
