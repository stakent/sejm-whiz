...
class TestMultiActAmendmentDetector:
    ...
    def test_edge_cases(self, detector, sample_document):
        ...
        assert (
            detector.detect_multi_act_amendments(sample_document, non_legal_content)
            is None
        )
        ...
        """
        result = detector.detect_multi_act_amendments(
            sample_document, false_positive_content
        )
