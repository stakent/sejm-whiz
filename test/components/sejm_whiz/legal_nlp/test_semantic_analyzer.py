...
import pytest
from sejm_whiz.legal_nlp.semantic_analyzer import (
...
class TestLegalSemanticAnalyzer:
    ...
    def test_identify_semantic_fields_civil_law(self):
        ...
        if len(fields) > 1:
            ...
            other_scores = [score for field, score in fields.items() if field != 'civil_law']
    ...
    def test_extract_semantic_relations(self):
        ...
        expected_types = ['causal_relations', 'temporal_relations', 'modal_expressions', 'conditional_relations']
    ...
    def test_definition_confidence_calculation(self):
        ...
        confidence2 = self.analyzer._calculate_definition_confidence(
            "x", 
            "y"
        )
        ...
        assert confidence1 > confidence2  # Better definition should have higher confidence
    ...
    def test_analyze_argumentative_structure(self):
        ...
        expected_types = ['premises', 'conclusions', 'counterarguments', 'justifications']
    ...
    def test_perform_comprehensive_semantic_analysis(self):
        ...
        analysis = self.analyzer.perform_comprehensive_semantic_analysis(self.civil_law_text)
