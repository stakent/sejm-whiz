...
from sejm_whiz.embeddings import (
    EmbeddingConfig, get_embedding_config,
    HerBERTEncoder, get_herbert_encoder,
...
from sejm_whiz.embeddings import core
...
def test_end_to_end_workflow_mock():
    ...
    with patch('sejm_whiz.embeddings.herbert_encoder.get_herbert_embedder') as mock_embedder, \
         patch('sejm_whiz.embeddings.bag_embeddings.get_herbert_encoder') as mock_bag_encoder:
        ...
        similarity_score = cosine_similarity(text_embedding, bag_result.document_embedding)
