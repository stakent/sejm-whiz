    ...
    async def test_database_component(self) -> None:
        ...
        try:
            ...
            for key, value in health.items():
                status_icon = (
                    "✅" if value else "❌" if isinstance(value, bool) else "ℹ️"
                )
        ...
        try:
            ...
            if health.get("connection"):
                ...
                self.test_results["redis"] = {
                    ...
                    "details": {
                        "connection": False,
                        "message": "Redis not available for testing",
                    },
                }
    ...
    async def test_embeddings_component(self) -> None:
        ...
        try:
            ...
            similarity = embedder.calculate_similarity(
                embedding_result.embedding, legal_embedding.embedding
            )
    ...
    async def test_full_pipeline_integration(self) -> None:
        ...
        try:
            ...
            embeddings_available = (
                self.test_results["embeddings"]["status"] == "success"
            )
...
async def main():
    ...
    try:
        ...
        failed_components = [
            comp for comp, result in results.items() if result["status"] == "failed"
        ]
