...
def test_sample_workflow():
    ...
    print(
        f"  Embedding magnitude: {sum(x**2 for x in sample_doc['embedding']) ** 0.5:.6f}"
    )
...
def main():
    ...
    try:
        ...
        print(
            "2. Run integration tests: pytest test/components/sejm_whiz/vector_db/test_integration.py"
        )
